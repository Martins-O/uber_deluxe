package com.paragon.uberdeluxe.utils;
...
public class AppUtilities {
    ...
    public static String getMailTemplate(){
        try(BufferedReader reader = new BufferedReader(new FileReader(
                "/home/martins/Java Projects/uberdeluxe/src/main/resources/welcome.txt"))){
    ...
    public static String getAdminMailTemplate(){
        try (BufferedReader reader = new BufferedReader(new FileReader(
                "/home/martins/Java Projects/uberdeluxe/src/main/resources/adminMail.txt"))){
            return reader.lines().collect(Collectors.joining());
        }catch (IOException e){
            throw new BusinessLogicException(e.getMessage());
        }
    ...
    public static String generateVerificationLink(Long userId){
        return USER_VERIFICATION_BASE_URL+"?userId="+"&token="+generateVerificationToken();
    }
